...
class EntityPreference(
    ...
    companion object {
        val defaultPreferenceAttackPlayer = EntityPreference(
            listOf(
                EntitySituation.SAME_ROOM_AS_PLAYER,
                EntitySituation.PLAYER_IS_ALIVE
            ),
        ...
        val defaultPreferenceFoundValuableItem = EntityPreference(EntitySituation.FOUND_VALUABLE_ITEM, EntityAction.GET_VALUABLE_ITEM)
        val defaultPreferenceAlwaysMoving = EntityPreference(EntitySituation.ANY, EntityAction.MOVE)

        val janitorPreferenceGetItem = EntityPreference(EntitySituation.FOUND_ANY_ITEM, EntityAction.GET_ANY_ITEM)
    }
}
